      ...
      <div class="grid md:grid-cols-2 items-center gap-8 h-full">
        ...
        <div class="flex items-center md:p-8 p-6 bg-[#0C172C] h-full lg:w-11/12 lg:ml-auto">
          ...
          <form class="max-w-lg w-full mx-auto">
            <div>
              <RouterLink to="/">
                <img src="../../assets/home-button.png" class="h-8 mb-8" alt="">
                </RouterLink>
            </div>
           
            <div class="mb-12">
              <h3 class="text-3xl font-bold text-blue-400">Create an account</h3>
            </div>
            ...
            <div class="mt-12">
                <button type="button" class="w-max shadow-xl py-3 px-6 text-sm text-gray-800 font-semibold rounded-md  bg-blue-400 hover:bg-blue-500 focus:outline-n">
                    Register
                </button>
              <p class="text-sm text-white mt-8">Already have an account? <RouterLink to="./login"><a href="" class="text-blue-400 font-semibold hover:underline ml-1">Login here</a></RouterLink></p>
            </div>
          </form>
        </div>
      </div>
